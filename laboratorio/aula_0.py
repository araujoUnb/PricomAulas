...
class aula_0(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Introdução ao GnuRadio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Introdução ao GnuRadio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "aula_0")
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Gráfico no tempo do sinal quadrático', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_number_sink_0.set_title('Potência')
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Espectro de frequência do sinal quadrático', #name
            1,
            None # parent
        )
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(1/1024)
        self.blocks_integrate_xx_0 = blocks.integrate_ff(1024, 1)
...
def main(top_block_cls=aula_0, options=None):
