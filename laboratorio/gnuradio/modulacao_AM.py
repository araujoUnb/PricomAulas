...
class modulacao_AM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulacao AM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacao AM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "modulacao_AM")
        ...
        self.qtgui_freq_sink_x_0_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Espectro de frequência do sinal recebido', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Espectro de frequência do sinal', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Espectro de frequência da mensagem', #name
            1,
            None # parent
        )
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/Users/araujo/OneDrive - unb.br/simulation/Pricom/gnuradio/file/Ensoniq-ZR-76-01-Dope-77.wav', True)
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
...
def main(top_block_cls=modulacao_AM, options=None):
