...
class test_gnuradio_lab_00(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_gnuradio_lab_00")
        ...
        self.frequencia = frequencia = 1000
        ...
        self.qtgui_freq_sink_x_2_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Sinal Demodulado e Filtrado', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_1_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Análise em frequência do sinal modulado com portadora', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_1 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Análise em frequência do sinal modulado', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Análise em Frequência da mensagem', #name
            1,
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self._frequencia_range = Range(100, 2000, 10, 1000, 200)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 6e3, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 6e3, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_freq_sink_x_2, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_2_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 2.5e3, 250, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=test_gnuradio_lab_00, options=None):
