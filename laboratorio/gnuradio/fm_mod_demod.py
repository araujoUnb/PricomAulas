...
# Title: Sistema de Transmissão FM
# Author: Daniel C. Araújo
# Description: Prática de Modula
...
import fm_mod_demod_m_t as m_t  # embedded python module



from gnuradio import qtgui

class fm_mod_demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sistema de Transmissão FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sistema de Transmissão FM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_mod_demod")
        ...
        self.nPoints = nPoints = int(samp_rate*t_max*2)
        self.message_gain_dB = message_gain_dB = 50
        self.k_f = k_f = 10
        self.f_c = f_c = 10e3
        ...
        # Blocks
        ##################################################
        self._message_gain_dB_range = Range(0, 100, 1, 50, 200)
        self._message_gain_dB_win = RangeWidget(self._message_gain_dB_range, self.set_message_gain_dB, 'message_gain_dB', "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._message_gain_dB_win)
        self._k_f_range = Range(10, 200, 1, 10, 200)
        self._k_f_win = RangeWidget(self._k_f_range, self.set_k_f, 'frequency-deviation constant', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        labels = ['Estimated Message', 'Message', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_number_sink_0_1.set_title('Baseband_power')
        ...
        self.qtgui_number_sink_0_0.set_title('Tx power')
        ...
        self.qtgui_freq_sink_x_0_0_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Passband FM Signal Spectrum + Noise', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Passband FM Signal Spectrum', #name
            1,
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0 = blocks.vector_source_f(m_t.message(B,t_max,samp_rate), True, 1, [])
        ...
        self.blocks_multiply_const_vxx_3 = blocks.multiply_const_ff(-10**(message_gain_dB/20))
        self.blocks_multiply_const_vxx_2_0 = blocks.multiply_const_ff(2)
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_ff(2)
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_ff(1/nPoints)
        ...
        self.blocks_integrate_xx_0_1 = blocks.integrate_ff(nPoints, 1)
        self.blocks_integrate_xx_0_0 = blocks.integrate_ff(nPoints, 1)
        ...
        self.analog_wfm_tx_0 = analog.wfm_tx(
        	audio_rate=int(nPoints/(2*t_max)),
        	quad_rate=int(decimation*nPoints/(2*t_max)),
        	tau=75e-6,
        	max_dev=k_f,
        	fh=-1.0,
        )
        self.analog_wfm_rcv_0 = analog.wfm_rcv(
        	quad_rate=int(nPoints/(2*t_max)),
        	audio_decimation=decimation,
        )
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, f_c, 1, 0, 0)
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, f_c, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, f_c, -1, 0, 0)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 10**(-SNR_dB/10), 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_multiply_const_vxx_2_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_multiply_const_vxx_2, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_multiply_xx_1, 1))
        ...
        self.connect((self.analog_wfm_tx_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_xx_1_0_0, 1))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_xx_1_1, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.qtgui_freq_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_add_xx_2, 0), (self.blocks_add_xx_1, 1))
        self.connect((self.blocks_complex_to_imag_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_complex_to_imag_0_0, 0), (self.blocks_multiply_xx_1_0, 1))
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.low_pass_filter_0_1, 0))
        self.connect((self.blocks_integrate_xx_0_0, 0), (self.blocks_multiply_const_vxx_1, 0))
        self.connect((self.blocks_integrate_xx_0_1, 0), (self.blocks_multiply_const_vxx_1_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_0, 0), (self.qtgui_number_sink_0_1, 0))
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self.blocks_multiply_xx_1_1, 1))
        self.connect((self.blocks_multiply_const_vxx_2_0, 0), (self.blocks_multiply_xx_1_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_3, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.blocks_multiply_const_vxx_3, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_1_0_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.blocks_multiply_xx_1_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.qtgui_time_sink_x_1, 1))
        ...
        self.connect((self.low_pass_filter_0_1, 0), (self.qtgui_freq_sink_x_0_0_0_0_0, 0))
    ...
    def set_t_max(self, t_max):
        self.t_max = t_max
        self.set_nPoints(int(self.samp_rate*self.t_max*2))
        self.blocks_vector_source_x_0.set_data(m_t.message(self.B,self.t_max,self.samp_rate), [])
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_1.set_taps(firdes.low_pass(1, self.samp_rate, self.W, 2e3, window.WIN_HAMMING, 6.76))
    ...
    def set_nPoints(self, nPoints):
        ...
        self.blocks_multiply_const_vxx_1_0.set_k(1/self.nPoints)

    def get_message_gain_dB(self):
        return self.message_gain_dB

    def set_message_gain_dB(self, message_gain_dB):
        self.message_gain_dB = message_gain_dB
        self.blocks_multiply_const_vxx_3.set_k(-10**(self.message_gain_dB/20))
    ...
    def set_f_c(self, f_c):
        ...
        self.analog_sig_source_x_0_1.set_frequency(self.f_c)
    ...
    def set_SNR_dB(self, SNR_dB):
        self.SNR_dB = SNR_dB
        self.analog_noise_source_x_0.set_amplitude(10**(-self.SNR_dB/10))
...
def main(top_block_cls=fm_mod_demod, options=None):
