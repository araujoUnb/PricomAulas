...
class FM_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.quad_rate = quad_rate = 12*samp_rate
        self.audio_gain = audio_gain = 100e-3

        ##################################################
        # Blocks
        ##################################################
        self._audio_gain_range = Range(0, 1, 50e-3, 100e-3, 200)
        ...
        self.connect((self.analog_nbfm_tx_0, 0), (self.blocks_throttle_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_quad_rate(12*self.samp_rate)
    ...
    def set_quad_rate(self, quad_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.quad_rate, 5e3, 2e3, window.WIN_HAMMING, 6.76))
