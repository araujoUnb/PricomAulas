...
import pulse_gen_signal as gen_signal  # embedded python module



from gnuradio import qtgui

class pulse(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Gen_pulse", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Gen_pulse")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pulse")
        ...
        # Variables
        ##################################################
        self.signal_len = signal_len = int(1024)
        self.samp_rate = samp_rate = 32000
        self.pulse_len = pulse_len = int(2**9)
        self.mu = mu = 0.8
        ...
        self.qtgui_freq_sink_x_1_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'Sinal Estimado na Frequência', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_1_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'AM Convencional com Diodo', #name
            1,
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_1 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            'AM Convencional na Frequência', #name
            1,
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0 = blocks.vector_source_f(gen_signal.sinc_gnu(100,32e-3,signal_len), False, 1, [])
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 10e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10e3, 1, 0, 0)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, mu)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_4, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_freq_sink_x_1_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_time_sink_x_3, 0))
    ...
    def set_signal_len(self, signal_len):
        ...
        self.blocks_vector_source_x_0.set_data(gen_signal.sinc_gnu(100,32e-3,self.signal_len), [])
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(-10, self.samp_rate, 1.1e3, 100, window.WIN_HAMMING, 6.76))
    ...
    def set_mu(self, mu):
        self.mu = mu
        self.analog_const_source_x_0.set_offset(self.mu)




def main(top_block_cls=pulse, options=None):
