...
import fm_modulation_m_t as m_t  # embedded python module



from gnuradio import qtgui

class fm_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_modulation")
        ...
        self.blocks_integrate_xx_0_1 = blocks.integrate_ff(1, 1)
        ...
        self.connect((self.blocks_integrate_xx_0_1, 0), (self.qtgui_number_sink_0_1, 0))
...
def main(top_block_cls=fm_modulation, options=None):
