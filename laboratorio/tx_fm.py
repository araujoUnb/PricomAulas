...
class tx_fm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_fm")
        ...
        # Blocks
        ##################################################
        self._kf_range = Range(10, 1000, 10, 50, 200)
        self._kf_win = GrRangeWidget(self._kf_range, self.set_kf, "Constante de proporcionalidade", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.blocks_vco_f_0_0 = blocks.vco_f(samp_rate, (2*3.14), 1)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(kf)
        self.blocks_moving_average_xx_0_1 = blocks.moving_average_ff(1024, ((1/1024)*(samp_rate/2/fm)), 4000, 1)
        ...
        self.connect((self.blocks_moving_average_xx_0_1, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_moving_average_xx_0_1, 0))
        ...
        self.connect((self.blocks_vco_f_0_0, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.blocks_vco_f_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_vco_f_0_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_moving_average_xx_0_1.set_length_and_scale(1024, ((1/1024)*(self.samp_rate/2/self.fm)))
    ...
    def set_kf(self, kf):
        self.kf = kf
        self.blocks_multiply_const_vxx_0_0.set_k(self.kf)
