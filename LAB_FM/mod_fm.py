...
class mod_fm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._k_f_win = RangeWidget(self._k_f_range, self.set_k_f, "Constante de proporcionalidade", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._k_f_win)
        self._ft_range = Range(1e3, 40e3, 1e3, 1e3, 200)
        self._ft_win = RangeWidget(self._ft_range, self.set_ft, "'ft'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ft_win)
        self._fcut_range = Range(1e3, 50e3, 500, f_c, 200)
        self._fcut_win = RangeWidget(self._fcut_range, self.set_fcut, "'fcut'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcut_win)
        self._K_range = Range(1, 100, 1, 50, 200)
        self._K_win = RangeWidget(self._K_range, self.set_K, "Amplificador", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(k_f)
    ...
    def set_k_f(self, k_f):
        self.k_f = k_f
        self.blocks_multiply_const_vxx_1.set_k(self.k_f)
